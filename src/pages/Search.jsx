...
const Search = () => {
  ...
  return (
   ...
   <div className='mx-4 lg:w-fit mt-4 md:mt-10 w-fit flex flex-row py-2 xl:py-1 justify-center px-2  border border-gray-300 rounded-lg border-solid items-center bg-white rounded-md'> 
         <form id="form">
